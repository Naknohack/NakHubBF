...
local Language = _G.SaveData["Language_Save"] or "vi"

local Lang = {
    ["Discord"] = {vi = "Discord", en = "Discord"},
    ["Sever"] = {vi = "Sever", en = "Server"},
    ["Cửa Hàng"] = {vi = "Cửa Hàng", en = "Shop"},
    ["Chính"] = {vi = "Chính", en = "Main"},
    ["Farm Thông thạo"] = {vi = "Farm Thông thạo", en = "Mastery Farm"},
    ["Farm Khác"] = {vi = "Farm Khác", en = "Other Farm"},
    ["Sea Event"] = {vi = "Sea Event", en = "Sea Event"},
    ["Tộc V4"] = {vi = "Tộc V4", en = "Race V4"},
    ["Drago Dojo"] = {vi = "Drago Dojo", en = "Dragon Dojo"},
    ["Chỉ số/Định vị"] = {vi = "Chỉ số/Định vị", en = "Stats / ESP"},
    ["Người chơi"] = {vi = "Người chơi", en = "Players"},
    ["Di chuyển"] = {vi = "Di chuyển", en = "Teleport"},
    ["Lấy vật phẩm & Update"] = {vi = "Lấy vật phẩm & Update", en = "Items & Update"},
    ["Raid/Fruit"] = {vi = "Raid / Fruit", en = "Raid / Fruit"},
    ["Cài đặt"] = {vi = "Cài đặt", en = "Settings"},

    -- 🔥 thêm cho dropdown language
...
function LoadUI()
    ...
    Window = Library:MakeWindow({
        Title = "Nak Hub V3", -- 🔥 không dùng L()
        SubTitle = "by Naknohack",
        SaveFolder = "Nak Hub"
    })

    CreateTabs() -- 🔥 bắt buộc gọi
end
-- Criar ScreenGui
local screenGui = Instance.new("ScreenGui")
...
local Maestry = Window:MakeTab({
    Title = L("Farm Thông thạo")
})
...
local Dojo = Window:MakeTab({
    Title = L("Drago Dojo")
})

local Esp = Window:MakeTab({
    Title = L("Chỉ số/Định vị")
})
...
Shop:AddButton({
    Name = L("Cutlass [ 1,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cutlass")
    end
})
Shop:AddButton({
    Name = L("Katana [ 1,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Katana")
    end
})
Shop:AddButton({
    Name = L("Iron Mace [ 25,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Iron Mace")
    end
})
Shop:AddButton({
    Name = L("Dual Katana [ 12,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Duel Katana")
    end
})
Shop:AddButton({
    Name = L("Triple Katana [ 60,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Triple Katana")
    end
})
Shop:AddButton({
    Name = L("Pipe [ 100,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Pipe")
    end
})
Shop:AddButton({
    Name = L("Dual-Headed Blade [ 400,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Dual-Headed Blade")
    end
})
Shop:AddButton({
    Name = L("Bisento [ 1,200,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Bisento")
    end
})
Shop:AddButton({
    Name = L("Soul Cane [ 750,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Soul Cane")
    end
})
Shop:AddButton({
    Name = L("Pole v.2 [ 5,000 Fragments ]"),
    Callback = function()
...
Shop:AddSection("Gun")
Shop:AddButton({
    Name = L("Slingshot [ 5,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Slingshot")
    end
})
Shop:AddButton({
    Name = L("Musket [ 8,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Musket")
    end
})
Shop:AddButton({
    Name = L("Flintlock [ 10,500 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Flintlock")
    end
})
Shop:AddButton({
    Name = L("Refined Slingshot [ 30,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
    end
})
Shop:AddButton({
    Name = L("Refined Flintlock [ 65,000 Beli ]"),
    Callback = function()
        local args = {
            [1] = "BuyItem",
            [2] = "Refined Flintlock"
...
Shop:AddButton({
    Name = L("Cannon [ 100,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cannon")
    end
})
Shop:AddButton({
    Name = L("Kabucha [ 1,500 Fragments]"),
    Callback = function()
...
Shop:AddButton({
    Name = L("Bizarre Rifle [ 250 Ectoplasm ]"),
    Callback = function()
        local Remote = game:GetService("ReplicatedStorage").Remotes.CommF_
...
Shop:AddButton({
    Name = L("Skyjump [ $10,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Geppo")
    end
})
Shop:AddButton({
    Name = L("Buso Haki [ $25,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Buso")
    end
})
Shop:AddButton({
    Name = L("Observation haki [ $750,000 Beli ]"),
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk", "Buy")
    end
})
Shop:AddButton({
    Name = L("Soru [ $100,000 Beli ]"),
    Callback = function()
...
Farm:AddSection(L("Auto Farm main"))
Farm:AddDropdown({
    Name = L("Chọn Vũ khí"),
    Description = "",
...
Farm:AddSection(L("Nguyên liệu"))
-- Dropdown de Selecionar Material
Farm:AddDropdown({
	Name = L("Chọn Nguyên liệu"),
	Description = "",
...
if World3 then
Farm:AddSection(L("Dark Dragger + Valkyrie"))
Farm:AddToggle({
    Name = L("Đánh Rip Indra"),
    Description = "",
...
Setting:AddSection(L("Manual Save"))

Setting:AddButton({
    Name = L("Salvar Configurações Agora"),
    Description = L("Cria um backup manual das tuas opções atuais"),
    Callback = function()
...
Setting:AddButton({
    Name = L("Resetar Configurações"),
    Description = L("Apaga o ficheiro de save e volta ao padrão"),
    Callback = function()
...
Setting:AddSection(L("Setting Farm"))
Setting:AddButton({
    Name = L("Dừng lại"),
    Description = "",
    Callback = function()
...
Setting:AddDropdown({
    Name = L("Ngôn ngữ"), -- 🔥 đây là cái bạn cần

    Options = {"Vietnamese","English"},

    Default = (Language == "vi" and "Vietnamese" or "English"),

    Callback = function(v)
        if v == "Vietnamese" then
            Language = "vi"
        else
            Language = "en"
        end
        ...
        _G.SaveData = _G.SaveData or {}
        _G.SaveData["Language_Save"] = Language
        SaveSettings()
...
Setting:AddToggle({
	Name = L("Safe Mode"),
	Description = L("turn on for safe ur health if low"),
	-- 1. Carrega o estado salvo
...
Setting:AddSection(L("Select"))
Setting:AddTextBox({
    Title = L("Bring Mobs Range"),
    Description = "",
    PlaceHolder = "235",
...
Others:AddToggle({
    Name = L("Mua mồi câu"),
    Description = L("Crafta a isca selecionada automaticamente"),
...
Others:AddToggle({
    Name = L("Tự động câu"),
    Description = L("Lança e puxa a vara automaticamente"),
    -- Carrega se estava ligado
...
Others:AddToggle({
    Name = L("Tự động nhận nhiệm vụ câu"),
    Description = L("Pega missão com o NPC Angler"),
    -- Carrega se estava ligado
...
Others:AddToggle({
    Name = L("Hoàn thành nhiệm vụ tự động"),
    Description = L("Entrega a quest automaticamente"),
    -- Carrega se estava ligado
...
-- 7. AUTO SELL FISH
Others:AddToggle({
    Name = L("Tự động bán cá"),
    Description = L("Vende peixes automaticamente"),
    -- Carrega se estava ligado
...
-- 8. AUTO SPAM SKILL Z
Others:AddToggle({
    Name = L("Tự động dùng skills Z câu"),
    Description = L("Spamma a skill Z da ferramenta equipada"),
    -- Carrega se estava ligado
...
Others:AddButton({
    Name = L("Cập nhật danh sách Boss"),
    Description = "",
    Callback = function()
        local LiveBosses = {}  
...
Others:AddToggle({
 ...
 Others:AddToggle({
    Name = L("Nhận nhiệm vụ đánh Boss"),
    Default = false,
    Callback = function(v)
 ...
 Others:AddToggle({
    Name = L("Farm tất cả Boss trong sever"),
    Description = "",
    Default = false,
    Callback = function(v)
        _G.FarmAllBoss = v
...
Others:AddSection(L("Quests"))
 Others:AddToggle({
    Name = L("Auto Farm Observation"),
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Others:AddSection(L("Cursed Swords"));
...
spawn(function()
 ...
 Others:AddToggle({
    Name = L("Tự động dựng lại khi có vật phẩm"),
    Description = "",
...
Others:AddSection(L("Buso/Aura Colours"));

 Others:AddToggle({
    Name = L("Teleport Barista Haki"),
    Description = "",
    -- 1. Carrega se estava ligado ou desligado ao abrir o script
...
if World3 then
 Others:AddToggle({
    Name = L("Tự động lấy Haki cầu vồng"),
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
spawn(function()
 ...
 Others:AddToggle({
    Name = L("Accept Quest Bypass [Risk]"),
    Description = "",
...
Event:AddSection(L("Sea Event / Setting Sail"))
local z5 = {
        "Guardian",
        "PirateGrandBrigade",
        "MarineGrandBrigade",
    ...
    if World3 then
        ...
        Event:AddDropdown({
            Name = L("Chọn vùng biển"),
            Description = L("Select danger level to travel"),
            Options = H5,
            Default = "Lv 1",
            Multi = false,
            Callback = function(I)
    ...
    Event:AddToggle({
        Name = L("Start farm"),
        Description = L("Auto Buy Boat & Move to Zone"),
        Default = false,
        Callback = function(I)
            _G.SailBoats = I;
        end,
...
Event:AddToggle({
        Name = L("Tốc độ thuyền"),
        Description = L("Enable custom boat speed"),
        Default = false,
        Callback = function(Value)
            _G.SpeedBoat = Value
        end
    ...
    Event:AddTextBox({
        Title = L("Boat Speed Value"),
        Description = L("Khuyến khích: 300"),
        PlaceHolder = "300",
        Default = "300",
        Callback = function(Value)
            local num = tonumber(Value)
...
Event:AddSection(L("Select what you will farm."))
    Event:AddToggle({
        Name = L("Auto Đánh Sea Beast"),
        Description = "",
        Default = false,
        Callback = function(I)
            _G.SeaBeast1 = I;
...
Event:AddToggle({
    Name = L("Auto Đánh Pirate GrandBrigade"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.PGB = I;
...
if World2 then
  Event:AddSection(L("Go to Sea 3 for more options."))
end
if World1 then
  Event:AddSection(L("Go to Sea 3 or Sea 2 for Farm maritime events"))
end
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
Event:AddToggle({
    Name = L("Auto đánh Shark"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.Shark = I;
...
Event:AddToggle({
    Name = L("Auto đánh Fish Crew Member"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.MobCrew = I;
...
Event:AddToggle({
    Name = L("Auto Đánh Haunted Crew Member"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.HCM = I;
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
Event:AddSection(L("Frozen Dimension"))
Event:AddButton({
	Name = L("Buy Spy"),
	Description = L("Buy the spy for finding leviathan"),
	Callback = function()
...
Event:AddToggle({
    Name = L("Auto tìm Frozen Dimension"),
    Description = "",
...
Event:AddToggle({
    Name = L("Di chuyển đến Frozen Dimension"),
    Description = "",
...
--// ================= TOGGLE =================
Event:AddToggle({
    Name = L("Bay Về Thuyền"),
    Description = "",
    Default = GetSetting("AutoBoat_Save", false),
    Callback = function(v)
        _G.AutoBoatFarm = v
        _G.SaveData["AutoBoat_Save"] = v
        SaveSettings()
    end
})
...
spawn(function()
    while task.wait(0.2) do
        if _G.AutoBoatFarm then
            pcall(function()

                local Boat = CheckBoat()
                local HRP = plr.Character.HumanoidRootPart

                -- ❌ Không có thuyền → đi mua
                if not Boat then
                    local BuyPos = CFrame.new(-16927.451, 9.086, 433.864) -- chỗ mua thuyền

                    -- 🚀 bay tới chỗ mua
                    _tp(BuyPos)

                    if (HRP.Position - BuyPos.Position).Magnitude <= 10 then
                        replicated.Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectedBoat)
                    end
                ...
                -- ✅ Có thuyền → xử lý ngồi
                local Seat = Boat:FindFirstChild("VehicleSeat")
                if Seat then
                    local distance = (HRP.Position - Seat.Position).Magnitude

                    -- ❗ Xa hoặc chưa ngồi → bay lại
                    if distance > 50 or not plr.Character.Humanoid.Sit then
...
Event:AddSection(L("Kitsune Island / Event"));
Event:AddToggle({
    Name = L("Auto tìm đảo Kitsune Island"),
    Description = L("turn on for finding & tween kitsune island"),
...
Event:AddToggle({
	Name = L("Auto Di chuyển đến đền Kitsune kích hoạt"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.tweenShrine = I;
...
Event:AddToggle({
    Name = L("Auto Thu thập Azure Ember"),
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Event:AddButton({ Name = "Talk with kitsune statue", Description = "", Callback = function()
	...
	Event:AddSection(L("Mystic Island / Full Moon"));
Event:AddToggle({
	Name = L("Auto tìm đảo Mirage Island"),
    Description = L("turn on for finding & tween mirage island"),
    -- 1. Carrega se estava ligado ou desligado
...
Event:AddToggle({
	Name = L("Auto bay đến điểm cao nhất"),
    Description = L("Voa até o ponto mais alto da Mirage (Ideal para olhar a Lua)"),
    -- 1. Carrega o estado salvo
...
Event:AddToggle({
	Name = L("Auto Nhặt Gear"),
    Description = L("Coleta a engrenagem na Mirage (Blue Gear)"),
...
Event:AddToggle({
	Name = L("Change Transparency can see"),
    Description = L("Deixa os obstáculos da Mirage transparentes"),
...
Event:AddToggle({
	Name = L("Auto Bay đến chỗ Người bán trái Blox nâng cao"),
    Description = L("Voa até o vendedor de frutas avançado na Mirage"),
    -- 1. Carrega se o teleporte estava ativo
...
Event:AddToggle({
	Name = L("Auto Nhặt rương ở đảo Mirage"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmChestM = I;
...
spawn(function()
	...
	Event:AddSection(L("Volcanic Magnet"));
-- Configurações de UI e Toggle
Event:AddToggle({
    Name = L("Auto Chế tạo Volcanic Magnet"),
    Description = L("Bật chế độ tự động Auto cày nguyên liệu và chế tạo nam châm núi lửa, và dừng lại khi bạn đã có 1 nam châm núi lửa"),
    Default = false,
    Callback = function(I)
        _G.CraftVM = I;
    end,
...
Event:AddButton({ 
    Name = L("Chế tạo Volcanic Magnet"), 
    Description = "", 
    Callback = function()
...
Event:AddSection(L("Prehistoric Island"));
Event:AddToggle({
    Name = L("Auto Tìm Prehistoric Island"),
    Description = "",
...
Event:AddToggle({
    Name = L("Auto Farm Đảo Prehistoric Island"),
    Description = "",
    -- 1. Carrega o estado salvo
...
-- 3. TOGGLE: Auto Reset
Event:AddToggle({
    Name = L("Auto Reset Khi hoàn thành đảo"),
    Description = "",
...
if World2 or World3 then
Event:AddSection(L("configures skills for maritime events (Melee)"))
-- [[ TOGGLES MELEE ]]
Event:AddToggle({
    Name = L("Skill Z"),
...
Maestry:AddSection(L("Thông thạo"))

local islands = { "Cake", "Bone" }
Maestry:AddDropdown({
    Title = L("Chọn phương pháp"),
    Description = "",
    Options= islands,
    Default = "Cake",
    Callback = function(I)
...
Maestry:AddToggle({
    Name = L("Auto Farm Thông thạo Fruit"),
    Description = "",
...
Maestry:AddToggle({
    Name = L("Auto Farm Thông thạo Gun"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.FarmMastery_G = I
...
if World2 then
Race:AddSection(L("Upgrade Races"));
Race:AddToggle({
    Name = L("Auto Mink V2/V3"),
    Description = "",
    Default = false,
    Callback = function(I)
        G.Auto_Mink = I;
...
Race:AddSection(L("Race upgrade v4 only in Sea 3"));
end
if World1 then
Race:AddSection(L("only in Sea 2 or 3 to upgrade to Race"));
end
if World3 then
Race:AddSection(L("Trials Quests / Misc V4"));
...
Race:AddToggle({
	Name = L("Auto Train V4"),
	Description = L("turn on for farm tier + auto upgrade your tier level"),
	Default = false,
	Callback = function(I)
		_G.AcientOne = I;
	end,
...
Race:AddButton({
    Name = L("Teleport to Temple of Time"),
    Description = "",
    Callback = function()
        pcall(function()
...
Race:AddButton({
    Name = L("Teleport to Ancient One"),
    Description = "",
    Callback = function()
        pcall(function()
            local TemplePos = CFrame.new(28286.35546875, 14895.301757812, 102.62469482422)
...
Race:AddButton({
    Name = L("Teleport to Ancient Clock"),
    Description = "",
    Callback = function()
        pcall(function()
            local TemplePos = CFrame.new(28286.35546875, 14895.301757812, 102.62469482422)
...
Race:AddToggle({
	Name = L("Auto Di chuyển đến cửa tộc"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.TPDoor = I;
...
Race:AddToggle({
	Name = L("Auto Hoàn thành Trial Tộc"),
	Description = "",
	Default = false,
	Callback = function(I)
...
Race:AddToggle({
	Name = L("Auto Kill Player Trong Trial"),
	Description = L("turn on for kill player after the race trials"),
	Default = false,
	Callback = function(I)
		_G.Defeating = I;
	end,
...
if World3 then
Dojo:AddSection(L("Dojo Quest & Drago Race"));
Dojo:AddToggle({
	Name = L("Auto Dojo Trainer"),
	Description = L("turn on for do dojo belt quest white to black"),
	Default = false,
	Callback = function(I)
		_G.Dojoo = I;
	end,
...
Dojo:AddToggle({
	Name = L("Auto Dragon Hunter"),
	Description = L("turn on for farm blaze ember + auto collect blaze ember"),
	Default = false,
	Callback = function(I)
		_G.FarmBlazeEM = I;
	end,
...
Dojo:AddToggle({
	Name = L("Tween To Upgrade Draco Trial"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.UPGDrago = I;
...
Dojo:AddToggle({
	Name = L("Auto race draco (V1)"),
	Description = L("turn on for auto quest1 auto prehistoric event + collect dragon eggs"),
	Default = false,
	Callback = function(I)
		_G.DragoV1 = I;
	end,
...
Dojo:AddToggle({
	Name = L("Auto race draco (V2)"),
	Description = L("turn on for auto kill Forest Pirate & Collect fireflower"),
	Default = false,
	Callback = function(I)
...
Dojo:AddToggle({
	Name = L("Auto race draco (V3)"),
	Description = L("turn on for sea event kill terror shark"),
	Default = false,
	Callback = function(I)
		_G.DragoV3 = I;
	end,
...
Dojo:AddToggle({
	Name = L("Auto Draco Trial V4"),
	Description = L("turn on for auto trial v4 you have to COLLECT RELIC by your self"),
	Default = false,
	Callback = function(I)
		_G.Relic123 = I;
	end,
...
Dojo:AddToggle({
	Name = L("Auto Trial Biến hình Tộc draco"),
	Description = L("turn on for training Drago race v4 + auto upgrade tier"),
	Default = false,
	Callback = function(I)
		_G.TrainDrago = I;
	end,
...
Dojo:AddToggle({
	Name = L("Bay"),
	Description = L("Dùng để khi Auto Trên lỗi dùng chay này thế"),
	Default = false,
	Callback = function(v)
		_G.Fly = v
	end,
...
Dojo:AddToggle({
	Name = L("Upgrade Dragon Talon V3"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.DT_Uzoth = I;
...
Dojo:AddSection(L("only in Sea 3"));
end
function isnil(I)
	return I == nil;
end;
...
-- UI E TOGGLES
Esp:AddSection(L("Esp Items / Entity / Island"));
...
Esp:AddSection(L("Stats"));

-- // AUTO STATS (Adicionado à aba VI_S conforme solicitado) // --

Esp:AddToggle({
    Name = L("Add Points Melee"),
    Description = L("Gasta pontos automaticamente em Melee"),
...
Esp:AddToggle({
    Name = L("Add Points Sword"),
    Description = L("Gasta pontos automaticamente em Sword"),
...
Esp:AddToggle({
    Name = L("Add Points Gun"),
    Description = L("Gasta pontos automaticamente em Gun"),
...
Esp:AddToggle({
    Name = L("Add Points Fruit"),
    Description = L("Gasta pontos automaticamente em Fruit"),
...
Esp:AddToggle({
    Name = L("Add Points Defense"),
    Description = L("Gasta pontos automaticamente em Defense"),
...
Player:AddSection(L("Pvp, aimbot, movement"))
...
Player:AddButton({
    Name = L("Làm mới danh sách người chơi"),
    Description = "",
    Callback = function()
        local NewPlayers = {}
...
Player:AddToggle({
	Name = L("Di chuyển đến người chơi"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.TpPly = I;
...
Player:AddToggle({
	Name = L("Spectate Choose Players"),
	Description = "",
	Default = false,
	Callback = function(I)
		SpectatePlys = I;
...
Player:AddSection(L("Aimbot"));

Player:AddToggle({
	Name = L("Aimbot Cam Lock"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AimCam = I;
...
Player:AddToggle({
	Name  = L("Chạy nhanh"),
    Description = L("Enable custom WalkSpeed"),
    Default = false,
    Callback = function(Value)
        SpeedEnabled = Value
        applyStats()
...
Player:AddTextBox({
    Name = L("Nhập"),
    Description = L("Digite a velocidade desejada"),
    PlaceHolder = "16",
...
Player:AddToggle({
	Name  = L("Nhảy cao"),
    Description = L("Enable custom JumpPower"),
    Default = false,
    Callback = function(Value)
        JumpEnabled = Value
        applyStats()
...
Player:AddTextBox({
    Name = L("Nhập"),
    Description = L("Digite o JumpPower desejado"),
    PlaceHolder = "50",
...
Player:AddSection(L("LocalPlayer Settings / Misc"));
Player:AddToggle({
	Name = L("Vô hạn Mink V3 [ INF ]"),
	Description = L("turn on for make mink v3 infinity"),
	Default = false,
	Callback = function(I)
		InfAblities = I;
	end,
...
Player:AddToggle({
	Name = L("Vô hạn Energy [ INF ]"),
	Description = L("turn on for make energy infinity"),
	Default = false,
	Callback = function(I)
		infEnergy = I;
		if I then
...
Player:AddToggle({
	Name = L("Vô hạn Soru [ INF ]"),
	Description = L("turn on for make soru infinity"),
	Default = false,
	Callback = function(I)
		_G.InfSoru = I;
		if I then
...
Player:AddToggle({
	Name = L("Instance Observation Range [ INF ]"),
	Description = L("turn on for make observation range infinity"),
	Default = false,
	Callback = function(I)
...
Player:AddSection(L("Settings Combat / Aimbot Settings"));
Player:AddToggle({
	Name = L("Bỏ qua các đội giống nhau"),
	Description = L("bật chế độ bỏ qua không phải aimbot cùng đội"),
	Default = false,
	Callback = function(I)
		_G.NoAimTeam = I;
	end,
...
Player:AddToggle({
	Name = L("Chấp nhận đồng minh"),
	Description = L("turn on for auto accept ally"),
	Default = false,
	Callback = function(I)
		_G.AcceptAlly = I;
	end,
...
Teleport:AddSection(L("Travel - Worlds"));
...
Teleport:AddSection(L("Travel - Island"))
...
Teleport:AddSection(L("Travel - Portal"));
if World1 then
...
Teleport:AddToggle({
	Name = L("Bay đến NPCs"),
	Description = L("Automatic teleport to pos Npcs"),
	Default = false,
	Callback = function(I)
		_G.TPNpc = I;
	end,
...
if World3 then
Get:AddSection(L("Skull Guitar"));
Get:AddToggle({
	Name = L("Auto Skull Guitar"),
	Description = "",
	Default = false,
	Callback = function(I)
...
if World2 or World3 then
Get:AddToggle({
	Name = L("Auto Farm Material Skull Guitar"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoMatSoul = I;
...
Get:AddToggle({
	Name = L("Auto Farm 600 In Swords"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmMastery_S = I
...
if World3 then
Get:AddSection(L("Cursed Dual Katana"));
...
Get:AddToggle({
 Name = L("Auto Lấy CDK [Nhiệm vụ cuối cùng]"),
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
if World2 then
Get:AddSection(L("True Triple Katana Sword"));
Get:AddToggle({
    Name = L("Auto Buy Legendary Sword"),
    Description = "",
...
Get:AddToggle({
 Name = L("Teleport Legendary Sword Dealer"),
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
    Default = GetSetting("TpLegendarySword_Save", false),
    Callback = function(I)
...
Get:AddSection(L("Raid Law"));

Get:AddToggle({
 Name = L("Auto Law Raid"),
    Description = "",
    Default = false,
    Callback = function(state)
        _G.AutoLawKak = state
...
if World1 then
Get:AddSection(L("world 1 items"));
Get:AddToggle({
 Name = L("Auto Lấy kiếm Saw"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoSaw = I;
...
Get:AddToggle({
 Name = L("Auto Lấy Áo choàng Hải Quân"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.MarinesCoat = I;
...
Get:AddToggle({
 Name = L("Auto Lấy Áo choàng Swan "),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.SwanCoat = I;
...
if World2 then
Get:AddSection(L("world 2 items"));
Get:AddToggle({
 Name = L("Auto Lấy Rengoku"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.AutoKeyRen = I
...
Get:AddToggle({
 Name = L("Auto Lấy Dragon Trident"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoTridentW2 = I;
...
Get:AddToggle({
 Name = L("Auto Lấy Áo choàng Gai Đen"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.BlackSpikey = I;
...
Get:AddToggle({
 Name = L("Auto Lấy Midnight Blade"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoEcBoss = I;
...
if World3 then
Get:AddSection(L("Sea 3"));
Get:AddToggle({
 Name = L("Auto Lấy kiếm Canvendish"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.Auto_Cavender = I;
...
Get:AddToggle({
 Name = L("Auto Lấy phụ kiện vòng hoa"),
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoKilo = I;
...
Fruit:AddToggle({
	Name = L("Tự động mua Chip Raid"),
	Description = L("Đợi 10s"),
	Default = false,
	Callback = function(state)
...
Fruit:AddToggle({
	Name  = L("Tự động bắt đầu Raid"),
    Description = L("Đợi 10s nếu trong sv có người khác đang Raid thì chức năng này ko tự vô đc mn thông cảm nha"),
    Default = false,
    Callback = function(I)
        _G.Auto_StartRaid = I;
    end,
...
Fruit:AddToggle({
	Name  = L("Tự động đánh quái+qua đảo"),
    Description = "",
    Default = false,
    Callback = function(I)
        _G.Raiding = I
...
Fruit:AddSection(L("Fruits Options"));
local J5 = {};
local function i5(I)
	local e = tostring(I);
	while true do
...
Fruit:AddToggle({
	Name  = L("Auto Random Fruit"),
    Description = L("Automatic random devil fruit"),
...
Get:AddToggle({
	Name = L("Auto Drop Fruit"),
	Description = L("Automatic drop devil fruit"),
	Default = false,
	Callback = function(I)
		_G.DropFruit = I;
	end,
...
Fruit:AddToggle({
	Name  = L("Auto Store Fruit"),
    Description = L("Automatic store devil fruit"),
...
Fruit:AddToggle({
	Name  = L("Auto Bay đến Fruit"),
    Description = L("Automatic tween to get devil fruit"),
    -- 1. Carrega o estado salvo
...
Fruit:AddToggle({
	Name  = L("Auto Collect Fruit"),
    Description = L("Automatic bring devil fruit"),
    -- 1. Carrega o estado salvo ou false por padrão
...
Setting:AddSection(L("Codes"));
Setting:AddButton({
	Name = L("Nhập hết Codes"),
	Description = "",
	Callback = function()
		local Codes = {
...
Setting:AddToggle({
	Name = L("Walk on Water"),
	Description = L("walk on water"),
	Default = true,
	Callback = function(I)
		_G.WalkWater_Part = I;
...
Setting:AddSection(L("Fps"));

Setting:AddButton({
    Name = L("Stretch the screen"),
    Description = "",
    Callback = function()
        -- SETAR A RESOLUÇÃO
        getgenv().Resolution = {
