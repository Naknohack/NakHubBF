...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Naknohack/RedzUi/refs/heads/main/UiRedzHubnew_UI_Scale.lua"))():MakeWindow({
    Title = "Nak Hub V4",
...
local function ApplyUIScale(choice)
    local scale = UIScaleChoiceMap[choice] or 450
    if Library and Library.SetScalePreset then
        pcall(function()
            Library:SetScalePreset(choice)
        end)
    elseif Library and Library.SetScale then
        pcall(function()
...
Farm:AddDropdown({
    Name = "UI Scale",
    Description = "Kích Thước Giao Diện",
    Options = {
        "Nhỏ",
        "Bình Thường",
        "To",
